...
public class AdminMessageListController implements Initializable {
    @FXML
    ...
    public void UpdateTable(){
        ...
        listM = HotelMain.getAdminMessages(HotelMain.getEmail());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        sender_col.setCellValueFactory(new PropertyValueFactory<AdminMessage,String>("senderID"));
        title_col.setCellValueFactory(new PropertyValueFactory<AdminMessage,String>("title"));
        content_col.setCellValueFactory(new PropertyValueFactory<AdminMessage,String>("content"));
