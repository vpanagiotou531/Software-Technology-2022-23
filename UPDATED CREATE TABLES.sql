...
CONSTRAINT SNDR FOREIGN KEY (SENDER_EMAIL) REFERENCES EMPLOYEE(EMAIL) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT RCVR FOREIGN KEY (RECEIVER_EMAIL) REFERENCES EMPLOYEE(EMAIL) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CONTENT VARCHAR(1000),
PRIMARY KEY (MESSAGE_ID),
CONSTRAINT ADMN_SNDR FOREIGN KEY (SENDER_EMAIL) REFERENCES ADMIN(EMAIL) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT EMPL_RCVR FOREIGN KEY (RECEIVER_EMAIL) REFERENCES EMPLOYEE(EMAIL) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
